    ...
    public static void main(String[] args) {
        ...
        if (choice == 0) {
            ...
            while (continuarPrograma) {
                ...
                String input = JOptionPane.showInputDialog("Ingrese la cantidad de moneda en soles peruanos: ");
                double soles;
                try {
        ...
        if (choice == 1) {
            ...
            while (SeguirPrograma) {
                ...
                int continuar = JOptionPane.showConfirmDialog(null, "¿Deseas continuar con el programa?", "",
                        JOptionPane.YES_NO_CANCEL_OPTION);
